...
よって、$$m^p\equiv m$$ならば$$(m+1)^p\equiv m+1$$。以上から数学的帰納法よりすべての$$a$$に対して$$a^{p}\equiv a \:\mathrm{mod}\:p$$。
