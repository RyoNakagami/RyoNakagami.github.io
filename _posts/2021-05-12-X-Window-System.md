...
<div style="display: inline-block; background: #D3D3D3;; border: 1px solid #D3D3D3; padding: 3px 5px;color:black"><span >Rule</span>
</div>
...
アプリケーション xclock を２台目のモニタに表示する場合は, Xクライアント側で環境変数 `DISPLAY`の設定が必要なので
